...
![Webhook Flowchart](../assets/webhook-flowchart.svg)
*Figure 1: How a webhook event travels from an external service to your app and back.*

![Webhook Sequence Diagram](../assets/webhook-sequence.svg)
*Figure 2: Sequence of communication between an external service and your webhook endpoint.*
